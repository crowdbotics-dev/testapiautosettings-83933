...
## Project Structure
    ...
    ├── testapiautosettings_83933  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_83933`
...
2. Clone this repo and `cd testapiautosettings_83933`
